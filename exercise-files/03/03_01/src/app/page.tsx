...
export default function Home() {
  return (
    <main className="flex items-center justify-center min-h-screen bg-gray-50">
        ...
        <div className="bg-white border-2 border-purple-100 rounded-lg p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="relative flex justify-center items-center">
            <Image
              ...
              alt="screenshot of the dasboard project showing desktop version"
            ></Image>
            <Image
              src="/image-mobile.jpeg"
              width={560}
              height={620}
              className="block rounded-md md:hidden z-10"
              alt="screenshot of the dasboard project showing desktop version"
            ></Image>
          </div>
        </div>
      ...
      <div
        className={`bg-purple-800 hidden md:block absolute top-0 right-0 bottom-0 left-2/3 z-0 ${styles.bg_wisteria}`}
      ></div>
    </main>
  );
}
